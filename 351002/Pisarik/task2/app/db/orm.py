...
class NewsOrm(Base):
    ...
    messages: Mapped[list[MessageOrm]] = relationship(back_populates="news", cascade="all,delete-orphan")


class MessageOrm(Base):
    __tablename__ = _tbl("message")
    ...
    news: Mapped[NewsOrm] = relationship(back_populates="messages")
