...
class Settings(BaseSettings):
    ...
    DISCUSSION_BASE_URL: str = Field(
        default="http://localhost:24130",
        description="Базовый URL модуля discussion (без завершающего /)",
    )
    ...
    KAFKA_NOTES_PUBLISHER_GROUP_ID: str = Field(default="publisher-notes-group")
    KAFKA_REQUEST_TIMEOUT_SECONDS: float = Field(default=5.0, ge=0.1, le=60.0)
