...
from src.api.v1.dep import get_news_service
from src.schemas.news import NewsRequestTo, NewsResponseTo
...
async def update(news_id: int, dto: NewsRequestTo, service: NewsService = Depends(get_news_service)):
