...
namespace Discussion.src.NewsPortal.Discussion.API.Controllers
{
    /// <summary>
    ...
    public class NoteController(INoteService noteService) : ControllerBase
    {
        ...
        /// <summary>
        /// Обновить существующую заметку (ID в теле запроса)
        /// </summary>
        /// <param name="noteRequest">Обновленные данные заметки (содержит ID)</param>
