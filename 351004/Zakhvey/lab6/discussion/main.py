...
app = FastAPI(title="Lab6 Discussion Service (Cassandra)")
...
def delete(id: int):
    if not DiscussionService.delete(id):
        raise HTTPException(status_code=404)
...
if __name__ == "__main__":
    uvicorn.run("lab6.discussion.main:app", host="0.0.0.0", port=24130, reload=True)
