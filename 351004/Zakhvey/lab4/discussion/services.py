...
class DiscussionService:
    ...
    def create(dto: CommentRequestTo) -> CommentResponseTo:
        ...
        CommentModel.create(country=country, issueId=dto.issueId, id=new_id, content=dto.content)
        CommentByIdModel.create(id=new_id, country=country, issueId=dto.issueId, content=dto.content)
