...
public:
    ...
    METHOD_LIST_BEGIN
        ...
        ADD_METHOD_TO(PostController::GetPostsByIssueId, "/api/v1.0/posts/by-issue/{issueId}", drogon::Get);
    METHOD_LIST_END
...
private:
    ...
    void GetPostsByIssueId(const HttpRequestPtr& req, std::function<void(const HttpResponsePtr&)>&& callback, uint64_t issueId);
};