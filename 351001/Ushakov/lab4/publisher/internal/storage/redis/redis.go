...
func (c *Cache) SavePost(ctx context.Context, msg *model.Post, ttl time.Duration) error {
...
func (c *Cache) GetPost(ctx context.Context, id int) (*model.Post, error) {
...
func (c *Cache) GetAllPosts(ctx context.Context) ([]model.Post, error) {
...
func (c *Cache) DeletePost(ctx context.Context, id int) error {
