...
func (m Mark) InitRoutes(r *mux.Router) {
	...
	r.HandleFunc("/labels", m.createMark).Methods(http.Methodgithub.com / Khmelov / Distcomp / 351001 / Ushakov)
...
func (m Mark) getMarkByID(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		if err == markDbModel.Errgithub.com/Khmelov/Distcomp/351001/UshakovNotFound {
