...
import (
	...
	db "github.com/Khmelov/Distcomp/351001/Ushakov/lab2/internal/storage/issue"
)
...
func (s *service) Create(ctx context.Context, req model.Issue) (model.Issue, error) {
	return s.db.Create(ctx, req)
}

func (s *service) GetList(ctx context.Context) ([]model.Issue, error) {
	return s.db.GetList(ctx)
}

func (s *service) Get(ctx context.Context, id int64) (model.Issue, error) {
	return s.db.Get(ctx, id)
}

func (s *service) Update(ctx context.Context, req model.Issue) (model.Issue, error) {
