...
@RestController
@RequestMapping({"/api/v1.0/messages", "/api/v1.0/notices", "/api/v1.0/reactions"})
@AllArgsConstructor
public class ReactionController {
    ...
    public ReactionResponseTo update(@PathVariable Long id, @RequestBody @Valid ReactionRequestTo request){
        request.setId(id);
