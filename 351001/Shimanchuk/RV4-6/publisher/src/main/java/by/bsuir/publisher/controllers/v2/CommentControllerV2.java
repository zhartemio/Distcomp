...
public class CommentControllerV2 {
    ...
    @PutMapping
    @PreAuthorize("hasRole('ADMIN') or @commentSecurity.isOwnerById(#comment.id, authentication.name)")
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN') or @commentSecurity.isOwnerById(#id, authentication.name)")
